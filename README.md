...
แนวคิดในการออกแบบ
แยกแต่ละส่วนออกจากกันเป็นอิสระ : หน้ารายการ Trader และหน้าต่างตัวกรอง ถูกออกแบบให้ทำงานแยกจากกัน โดยคุยกันผ่านบอร์ดกลาง (Riverpod) แทนการส่งข้อมูลข้ามไปข้ามมาทาง Constructor ทำให้ในอนาคตถ้าอยากยกตัวกรองนี้ไปใช้กับหน้าอื่น ก็หยิบไปใช้ได้ทันที
